      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.titleRow}>
          ...
          <TouchableOpacity style={styles.addBtn} onPress={() => setAdding(!adding)}>
            <Ionicons name={adding ? 'close' : 'add'} size={22} color={Colors.textPrimary} />
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  goalLabel: { fontSize: FontSize.md, fontWeight: '600', color: Colors.textPrimary },
  ...
  goalFooter: { flexDirection: 'row', alignItems: 'center', gap: Spacing.xs },
  goalCurrent: { fontSize: FontSize.lg, fontWeight: '600', color: Colors.accentActive },
